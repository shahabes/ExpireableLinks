...
<div class="container">
    <div class="row mt-5 p-5 shadow rounded bg-white">
        <h2 class="col-12 mb-4">
            کاربر عزیز، لینک شما فاقد اعتبار است.
        </h2>
        <p class="header-caption col-12">
                کاربر عزیز، فایل
<b class="text-success">{{ $title }}</b>
            قبلا توسط شما دانلود شده است و دیگر قابل دانلود نیست.
            <span>
                در صورتی که به هر دلیلی، موفق به دریافت فایل نشده اید، با پشتیبانی تماس بگیرید تا لینک برای شما تمدید شود.
            </span>
        </p>
